...
import {AlbumSeriesEditorComponent} from "./admin/assets/components/album-series-editor/album-series-editor.component";
...
const routes: Routes = [
  ...
  {path: 'admin', component: LayoutComponent, children: [
      ...
      {path: 'album/:id', component: AlbumSeriesEditorComponent},
    ]},
];
